...
class Config:
    ...
    MODEL = {
        "face_stream": {
            "rgb_backbone": "simple_cnn",  # "simple_cnn"/"resnet50"/"efficientnet_b0"/"mobilenet_v3_small"/"mobilenet_v3_large"/"vit_b_16"/"swin_t"/"clip_vit_b32"
            "rgb_pretrained": False,  # only applies to torchvision backbones
            "rgb_feature_dim": 256,
            "freeze_backbone": False,  # Phase 0: freeze face backbone (auto-enabled for ViT/Swin/CLIP)
            "uv_hist_bins": 64,
