function [outnew,dest_lab,bull_nosd] = img_AddRender_simp_D65(img, bull,bull_nosd, string, ...
    delta_Lab,XYZ,noFaceRGB_file,if_wei,if_2mask,CCT)
% ======================================
...
%%
    ...
    if strcmp(string,"srgb")
        ...
        a=[0.9015  500.0089];
        D=a(1).*(1-a(2)./CCT);
        XYZ_aft = CAT16_D(xyz2,  XYZw_pre,wd65_64, D);
