...
% %---------------femaleVIVO------------
    ...
    source_folder=char(fullfile('..\..\H_raw_images\RealScene',model,'raw\noCard'));
    dir_pic=dir(fullfile(source_folder,"*.3FR"));
    source_folder1=char(fullfile('..\..\H_raw_images\RealScene',model,'raw\card'));
    ...
    save_folder=fullfile("D:\work\VIVOskinExpe\analyze\optimizedD\card",lastPart);
    ...
    for i_pic=1:length(dir_pic)
        ...
        outputFolder=fullfile(save_folder,"check_mask");
        ...
        outputFolder=fullfile(save_folder,"white_sq");
        if ~exist(outputFolder,"dir")
            mkdir(outputFolder)
        end
    ...
    %----------
        ...
        %     "XYZ_cropped","XYZw_max","XYZw","XYZw_white");
        save(fullfile(save_folder,strcat(dir_pic(i_pic).name(1:end-4),".mat")), ...
            "XYZ1_cropped","XYZw_max","XYZw","XYZw_white");
