...
exportgraphics(h2,fullfile(save_folder,"lab_selected_from_low.jpg"),"Resolution",150);
...
for i = 1:length(Lc2)
  ...
  exportgraphics(h3,fullfile(save_folder,"lab_selected_from_high.jpg"),"Resolution",150);
%% 
...
labs = lab_clean(idselect, :);
  ...
  exportgraphics(h1,fullfile(save_folder,"show_lab_selected.jpg"),"Resolution",150);
