...
% This is a demonstration of how to create and manage options for pattern 
% search using the PSOPTIMSET function in the Global Optimization Toolbox.

%   Copyright 2004-2010 The MathWorks, Inc.
%   $Revision: 1.1.6.3 $   $Date: 2010/02/08 22:34:31 $
...
% LINCONTEST7 which is in the MATLAB file 'lincontest7.m'. We pass a function
...
% is said to be active with respect to the current point; the active
