...
%   $Revision: 1.1.6.2 $  $Date: 2009/10/10 20:10:06 $
...
reset(RandStream.getDefaultStream); % Reset the state of random number generator
...
plot3(X0(1),X0(2),Objfcn(X0),'or','MarkerSize',10,'MarkerFaceColor','r');
fig = gcf;
...
% the FMINUNC function from the Optimization toolbox as our hybrid function
