...
%   $Revision: 1.1.6.11 $  $Date: 2010/11/08 02:22:09 $
...
%   See also GLOBALSEARCH, RUN, MULTISTART
       ...
       function obj = set.NumTrialPoints(obj,value)
           ...
           error(typeValueChecker('posInteger',value,'NumTrialPoints'));          
           obj.NumTrialPoints = value;
       end       
       function obj = set.BasinRadiusFactor(obj,value)
           % error check for BasinRadiusFactor property
           error(typeValueChecker('boundedReal',value,'BasinRadiusFactor',[0 1]));
       ...
       function obj = set.PenaltyThresholdFactor(obj,value)
           ...
           error(typeValueChecker('nonNegReal',value,'PenaltyThresholdFactor'));
...
%   See also GLOBALSEARCH
        ...
        probValidValues = {{'fmincon'}, {}, {} };
        error(obj.checkProblem(problem, probRequiredFields, probValidValues));
