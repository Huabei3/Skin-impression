function XYZc=xyz2xyzcCAT02_2(XYZ,XYZ1w,XYZ2w,La,surround,dc)
...
%used.
%Only PART1 of paper is taken into account (no Ds factor!)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xy=xyz2xyY(XYZ1w);
xyn=[0.319,0.319];Pxy=sqrt((xy(1)-xyn(1)).^2+(xy(2)-xyn(2)).^2);%Purity
