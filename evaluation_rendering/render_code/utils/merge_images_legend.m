function merge_images(source_folder, add_labels)
    ...
    img1=imresize(img1,[size(img1,1), size(img1,2)]);
    img2 = imread(img2_path);
    img2=imresize(img2,[size(img2,1)*2, size(img2,2)*2]);
    ...
    if add_labels
        ...
        font_size_ratio1=5;
        font_size_ratio=50;
        font_size_number1 = round(w1 / font_size_ratio);
        font_size_number = min(font_size_number1, round(h1 / font_size_ratio1));
        ...
        font_size_number2 = round(w2_padded / font_size_ratio);
        font_size_number = min(font_size_number2, round(h2_padded / font_size_ratio1));
        font_size_number = min(font_size_number, 200);
...
%%
source_folder="D:\work\VIVOskinExpe\skin_model\evaluation_rendering\render_code\compare\res\pic\on_Peggy_OPPO\concatenated\picked";
