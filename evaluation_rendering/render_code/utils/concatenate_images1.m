function concatenate_images1(save_folder,n_col)
    ...
    for i = 1:num_images
        ...
        % text_position_number = [cols - font_size_number*2.5, rows - font_size_number*4];
...
%%
% concatenate_images1("D:\work\VIVOskinExpe\skin_model\evaluation_rendering\render_code\compare\res\pic\on_Peggy_OPPO\concatenated\picked",1)