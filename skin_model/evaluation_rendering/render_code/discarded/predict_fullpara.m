...
obs_type="non_model";
% 定义输出Excel文件的完整路径
excel_output_path_r = fullfile('..\..\data', 'correlation_results',"fullpara",strcat(iOr,obs_type,'_r.xlsx'));
excel_output_path_mape = fullfile('..\..\data', 'correlation_results',"fullpara",strcat(iOr,obs_type,'_mape.xlsx'));
        ...
        for attribute_idx_in_list = 1:length(attributes_to_process)
            ...
            if iOr=='r'
                source_folder=fullfile("D:\work\VIVOskinExpe\analyze\AnalyseResults_p", ...
                    Dtype,scale_type_origin,"50","nation1", ...
