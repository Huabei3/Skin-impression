function th=rotateticklabel(h,rot,fsize)
...
if rot<180
    ...
    th=text(b,repmat(c(1)-.1*(c(2)-c(1)),length(b),1),a,'HorizontalAlignment','left','rotation',rot,'FontSize',fsize);
end
