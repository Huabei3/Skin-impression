...
% 假设自定义光源的参考白点XYZ
XYZ_ref_white_example=[94.811 100.00 107.304];
% XYZ_ref_white_example =[95.047 100.00 108.883];  

% 3. 调用predict_ref方法进行预测
[RefP_out, XYZP_calculated, labP_predicted, m_deP] = reflectancePredictor.predict_ref(XYZ_target_example, 3, XYZ_ref_white_example);
...
concatenate_images1(save_folder,cols);
%%
