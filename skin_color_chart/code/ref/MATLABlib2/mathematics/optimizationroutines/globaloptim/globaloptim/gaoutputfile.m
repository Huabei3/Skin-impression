...
if fid==-1
    error('globaloptim:gaoutputfile:fileError','Error trying to write to %s:\n%s',fileName,theMessage)
end
...
st = fclose(fid);
if st ~= 0
    error('globaloptim:GAOUTPUTFILE:fileError','%s%s','Error closing file ',fileName)
end
