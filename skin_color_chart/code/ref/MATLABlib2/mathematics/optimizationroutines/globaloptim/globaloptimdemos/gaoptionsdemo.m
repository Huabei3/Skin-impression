...
% This is a demonstration of how to create and manage options for the genetic 
% algorithm function GA using GAOPTIMSET in the Global Optimization Toolbox.

%   Copyright 2004-2009 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2009/10/10 20:10:04 $

%% Setting Up a Problem for GA
% GA searches for a minimum of a function using the genetic algorithm. For
% this demo we will use GA to minimize the fitness function SHUFCN. SHUFCN
...
% often best done by experimentation. The OPTIMTOOL provides a wonderful
