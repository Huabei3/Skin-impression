function concatenate_images1(save_folder,n_col)
    ...
    for i = 1:num_images
        ...
        text_position_number = [cols - font_size_number*2, rows - font_size_number*2];
...
%%
% concatenate_images1("D:\work\VIVOskinExpe\skin_color_chart\code\res\adjusted\show_lab_selected",4)